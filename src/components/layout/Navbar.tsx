  ...
  return (
    ...
    >
      <nav className="flex h-16 items-center justify-between px-5 md:px-10">
        ...
        <Link
          href="/"
          className="font-display text-3xl uppercase leading-none tracking-tight transition-colors hover:text-accent focus-visible:outline-2 focus-visible:outline-offset-2 active:text-accent"
        >
          Lumo
        </Link>
          ...
          <ul className="flex items-center gap-6">
            {nav.items.map((item) => (
              <li key={item.href}>
                <Link
                  href={item.href}
                  className="font-mono text-xs uppercase tracking-[0.15em] text-muted-foreground transition-colors hover:text-accent focus-visible:outline-2 focus-visible:outline-offset-2 active:text-accent"
                >
                  {item.label[locale]}
                </Link>
              </li>
